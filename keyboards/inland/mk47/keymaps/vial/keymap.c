...
// This keymap mostly matches the keycaps provided by Inland, and also includes all the missing characters.
//
// L0 Bottom row is CTRL, CODE, ALT, HYPER(L5), LOWER(FN1/3), SPACE, RAISE(FN2/3), FN(L4), LEFT, DOWN, RIGHT
...
//     Plus HYPER-RAISE and HYPER_LOWER are vol-up and vol-down
