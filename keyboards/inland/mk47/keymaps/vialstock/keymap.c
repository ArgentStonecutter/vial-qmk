...
// This is mostly the shipped weird keymap exacpt it uses RAISE and LOWER instead of MO(1) and MO(2) so you can hold
// them both for layer 3. THIS DOES NOT MATCH THE SHIPPED KEYCAPS
