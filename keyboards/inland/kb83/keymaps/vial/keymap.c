...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT( /* FN */
		...
		_______, GU_TOGG, _______,                   _______,                            MO(X_OPTION),_______,MO(X_MEDIA),  RM_SPDD, RM_VALD, RM_SPDU),
    ...
    [MAC_FN] = LAYOUT( /* FN */
		...
		_______, _______, _______,                   _______,                            MO(X_OPTION),_______,MO(X_MEDIA),  RM_SPDD, RM_VALD, RM_SPDU),

    [X_MEDIA] = LAYOUT( /* FN */
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RM_TOGG,       _______,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RM_NEXT,       RM_PREV,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,       RM_HUEU,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                RM_HUED,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                RM_VALU, RM_NEXT,
		_______, _______, _______,                   _______,                            _______, _______, _______,       RM_SPDD, RM_VALD, RM_SPDD),

    [X_OPTION] = LAYOUT( /* FN */
		QK_DEBUG_TOGGLE,QK_REBOOT,QK_BOOTLOADER,QK_CLEAR_EEPROM,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______, _______,
...
QK_BOOTLOADER, QK_REBOOT, QK_DEBUG_TOGGLE, QK_CLEAR_EEPROM,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [X_MEDIA] =  { ENCODER_CCW_CW(KC_VOLD, KC_VOLD) },
    [X_OPTION] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLD) },
};
#endif
